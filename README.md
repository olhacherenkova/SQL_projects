...
Цей запит формує місячну статистику відправлених email-повідомлень по акаунтах і показує їхню частку від загальної кількості повідомлень у цьому місяці
